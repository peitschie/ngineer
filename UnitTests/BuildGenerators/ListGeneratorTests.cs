...
namespace NGineer.UnitTests.BuildGenerators
{
    ...
    public class ListGeneratorTests : GeneratorTestFixture<ListGenerator>
    {
        ...
        {
            return new BuildSession(new TestBuilder{ CollectionSizes = new TypeRegistry<Range>(), DefaultCollectionSize = new Range(10, 10)}, null, new Random(10));
        }
        ...
        public void Create_ChecksCollectionSizeForComplexClassType()
        {
            ...
            var session = new BuildSession(new TestBuilder { CollectionSizes = registry, DefaultCollectionSize = new Range(10, 10)}, null, new Random(10));
